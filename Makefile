...
GO_BUILD_LDFLAGS=  -X main.BuildCommit=$(GO_SERVICE_BUILD_COMMIT)
GO_BUILD_LDFLAGS+= -X main.BuildBranch=$(GO_SERVICE_BUILD_BRANCH)
GO_BUILD_LDFLAGS+= -X main.BuildTag=$(GO_SERVICE_BUILD_TAG)
